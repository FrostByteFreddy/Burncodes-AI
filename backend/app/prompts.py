...
REPHRASE_PROMPTS = {
    ...
    'de': ("system", "Formulieren Sie, gegeben einen Chat-Verlauf und eine Folgefrage, die Folgefrage so um, dass sie eine eigenständige Frage ist."),
...
FINE_TUNE_RULE_PROMPTS = {
    ...
    'de': "- Wenn die Frage des Benutzers sich auf '{trigger}' bezieht, müssen Sie dieser Anweisung folgen: '{instruction}'",
