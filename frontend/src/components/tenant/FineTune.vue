      ...
      <div v-for="(rule, index) in rules" :key="index" class="bg-base-200 p-4 rounded-lg">
        <div class="flex justify-between items-start space-x-4">
          <div class="flex-grow space-y-2">
            <div>
              <label :for="`trigger-${index}`" class="block text-sm font-medium text-base-content">Trigger</label>
            ...
            <div>
              <label :for="`instruction-${index}`" class="block text-sm font-medium text-base-content">Instruction</label>
