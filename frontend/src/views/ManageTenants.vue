<template>
  <div class="p-6">
    ...
    <!-- Empty State -->
    <div v-else-if="!tenantsStore.loading && tenantsStore.tenants.length === 0" class="text-center bg-base-100 p-12 rounded-lg shadow-md">
    ...
    <div v-else class="space-y-4">
      <div v-for="tenant in tenantsStore.tenants" :key="tenant.id" class="bg-base-100 p-6 rounded-lg flex justify-between items-center shadow-md">
        <div>
