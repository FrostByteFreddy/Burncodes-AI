  ...
  <div class="max-w-2xl">
    ...
    >
      ...
      <div class="flex space-x-4">
        <div class="w-1/2">
          <label for="firstName" class="block text-sm font-medium text-base-content">
        ...
        <div class="w-1/2">
          <label for="lastName" class="block text-sm font-medium text-base-content">
            {{ $t("profile.last_name") }}
          </label>
          <div class="relative">
            <span class="absolute inset-y-0 left-0 flex items-center pl-3">
      ...
      <div>
        <label for="phone_number" class="block text-sm font-medium text-base-content">
      ...
      <div>
        <label for="language" class="block text-sm font-medium text-base-content">
          {{ $t("profile.language") }}
        </label>
        <div class="relative">
          <span class="absolute inset-y-0 left-0 flex items-center pl-3">
